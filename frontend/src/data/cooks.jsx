// Yummara — prototype data (cooks + dishes)
...
const YUM_COOKS = [
  {
    ...
    area: 'Indiranagar',
    distance: '1.2 km',
    tags: 'South Indian · Tamil · Tiffin',
    rating: 4.9,
    count: 312,
    prepTime: '25–35 min',
    tone: 'warm',
    ...
    yearsCooking: 'Cooking on Yummara since 2024',
    ...
    schedule: 'Mon–Sat · 6am–9pm · Closed Sundays',
    minOrder: 95,
    dishes: [
  ...
  {
    id: 'rukmini',
    name: "Rukmini D'Souza",
    short: 'Rukmini',
    area: 'Koramangala',
    distance: '0.8 km',
    tags: 'Mangalorean · Coastal',
    rating: 4.7,
    count: 178,
    prepTime: '35–45 min',
    tone: 'green',
    ...
    yearsCooking: 'On Yummara since 2024',
  ...
  },
  {
    ...
    yearsCooking: 'On Yummara since 2025',
    ...
    schedule: 'Mon · Wed · Fri · Sat · 12pm–3pm + 7pm–9:30pm',
    minOrder: 140,
    dishes: [
  ...
  },
  {
    ...
    yearsCooking: 'On Yummara since 2023 · most-ordered cook in HSR',
  ...
  },
  {
    ...
    name: 'Bhumi Patel',
    short: 'Bhumi',
    area: 'Koramangala 5th',
    distance: '1.3 km',
    tags: 'Gujarati · Sattvik',
    rating: 5.0,
    count: 4,
    prepTime: '30–40 min',
    tone: 'green',
    ...
    yearsCooking: 'New on Yummara · joined last week',
  ...
  },
  {
    ...
    yearsCooking: 'New on Yummara · joined this week',
...
const YUM_ALL_DISHES = YUM_COOKS.flatMap(c =>
...
Object.assign(window, {
  YUM_COOKS, YUM_INDEX, YUM_ALL_DISHES,
  yumFindCookByName, yumFindDish,
});
